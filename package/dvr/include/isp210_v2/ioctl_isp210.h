...
// IOCTL version
//============================================================================
#define ISP_IOCTL_VER   ((1<<16)|(3<<8)|(0<<4)|0)  /* 1.3.00 */
...
//#define ISP_IOC_SET_IMGSIZE         _IOW(ISP_IOC_ISP, 3, struct win_size)
