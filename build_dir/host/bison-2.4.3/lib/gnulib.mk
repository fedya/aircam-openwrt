...
# Reproduce by: gnulib-tool --import --dir=. --local-dir=gl --lib=libbison --source-base=lib --m4-base=m4 --doc-base=doc --tests-base=tests --aux-dir=build-aux --no-libtool --macro-prefix=gl announce-gen argmatch assert c-strcase config-h configmake dirname error extensions fopen-safer gendocs getopt-gnu gettext git-version-gen hash inttypes javacomp-script javaexec-script maintainer-makefile malloc mbswidth obstack pipe quote quotearg stdbool stpcpy strerror strtoul strverscmp unistd unistd-safer unlocked-io unsetenv update-copyright verify warnings xalloc xalloc-die xstrndup
...
EXTRA_libbison_a_SOURCES += cloexec.c
...
EXTRA_libbison_a_SOURCES += basename-lgpl.c dirname-lgpl.c stripslash.c
...
libbison_a_SOURCES += pipe.h pipe.c w32spawn.h
...
EXTRA_libbison_a_SOURCES += stdio-write.c
