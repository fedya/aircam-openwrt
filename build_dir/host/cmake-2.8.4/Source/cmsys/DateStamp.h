...
#define cmsys_DATE_STAMP_MONTH         02

/** Version date integer day.  The format is DD.  */
#define cmsys_DATE_STAMP_DAY           15

/** Version date full integer.  The format is CCYYMMDD.  */
#define cmsys_DATE_STAMP_FULL          20110215
...
#define cmsys_DATE_STAMP_STRING_MONTH "02"

/** Version date string day.  The format is "DD".  */
#define cmsys_DATE_STAMP_STRING_DAY   "15"

/** Version date full string.  The format is "CCYYMMDD".  */
#define cmsys_DATE_STAMP_STRING_FULL  "20110215"

/** Version date formatted string.  The format is "CCYY-MM-DD".  */
#define cmsys_DATE_STAMP_STRING       "2011-02-15"
