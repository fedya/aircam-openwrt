...
#define FTSSP010_SPI_CS_NR_0      6
#define FTSSP010_SPI_CS_NR_1      1
...
struct ftssp010_spi_hw_platform {
    ...
    int hw_rx_dma_pin;
    int hw_tx_dma_pin;
    int (*cs_high)(enum FTSSP010_SPI_CS cs); // pull up chip select cs high
    int (*cs_low)(enum FTSSP010_SPI_CS cs); // pull down chip select cs low
};
