/*
 *  arch/arm/mach-faraday/include/mach/platform-a369/misc_spec.h
 *
 *  Faraday A369 platform dependent definitions
 *
...
#ifndef __ASSEMBLY__
extern unsigned int a369_get_ahb_clk(void);
extern unsigned int a369_get_apb_clk(void);
#define AHB_CLK_IN	a369_get_ahb_clk()
#define APB_CLK_IN	a369_get_apb_clk()
#endif //__ASSEMBLY__
