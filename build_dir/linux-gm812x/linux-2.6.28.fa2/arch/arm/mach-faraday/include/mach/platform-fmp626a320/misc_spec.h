/*
 *  arch/arm/mach-faraday/include/mach/platform-a320/misc_spec.h
 *
...
#ifndef __ASSEMBLY__
extern unsigned int a320_get_ahb_clk(void);
extern unsigned int a320_get_apb_clk(void);
#define AHB_CLK_IN    a320_get_ahb_clk()
#define APB_CLK_IN    a320_get_apb_clk()
#endif
...
/* XXX temp */
#define PLATFORM_GIC_DIST_VA_BASE	0x10000000
#define PLATFORM_GIC_CPU_VA_BASE	0x20000000
#define PLATFORM_SCU_VA_BASE		0x30000000
#define PLATFORM_SYS_VA_BASE		0x40000000
#define PLATFORM_TWD_VA_BASE		0x50000000
#define PLATFORM_TWD_SIZE		0x00000100

#define PLATFORM_LEGACY_IRQ		28
