 ...
 */
static struct fttmr010_clocksource *fttmr010_cs;

static cycle_t fttmr010_clocksource_read(void)
{
	cycle_t counter;

	counter = fttmr010_get_counter(fttmr010_cs->base, fttmr010_cs->id);
	return ~counter;
}
