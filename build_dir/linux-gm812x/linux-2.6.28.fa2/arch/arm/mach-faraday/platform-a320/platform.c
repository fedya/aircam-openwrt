...
static unsigned int a320_get_cpu_clk(void)
{
	void __iomem *base = (void __iomem *)PMU_FTPMU010_VA_BASE;

	return ftpmu010_get_cpuclk(base);
}
...
{
	unsigned int cpuclk = a320_get_cpu_clk();
	unsigned int hclk = a320_get_ahb_clk();
	unsigned int pclk = a320_get_apb_clk();
