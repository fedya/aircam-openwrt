...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_common_h[] = {
  {
    &c_global_trees[0],
    1 * (CTI_MAX),
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_rd_gt_c_common_h[] = {
  { &tree_vector_cache, 1, sizeof (tree_vector_cache), NULL, NULL },
  LAST_GGC_ROOT_TAB
};

EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_c_common_h[] = {
