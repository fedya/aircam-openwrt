...
#ifdef CONFIG_GPIO_INTERRUPT_API
...
struct gpio_chip {
    ...
    int         (*int_setup)(struct gpio_chip *chip, unsigned offset, const struct gpio_interrupt_mode *mode);
...
extern int gpio_interrupt_setup(unsigned gpio, struct gpio_interrupt_mode *mode);
...
#endif /* CONFIG_GPIO_INTERRUPT_API */
