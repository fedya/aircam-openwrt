...
#ifndef __FARADAY_PLATFORM_INDEPENDENT_IRQS_HEADER__
#define __FARADAY_PLATFORM_INDEPENDENT_IRQS_HEADER__

/* Include platform *dependent* IRQ definitions */
#include <mach/platform/irqs.h>

#endif /* __FARADAY_PLATFORM_INDEPENDENT_IRQS_HEADER__ */
