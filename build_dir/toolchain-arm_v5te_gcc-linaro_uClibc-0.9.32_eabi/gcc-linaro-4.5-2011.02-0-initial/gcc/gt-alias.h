    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_17alias_set_entry_d ((*x).base.vec[i0]);
        }
      }
    }
}
    ...
    {
      {
        ...
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_17alias_set_entry_d ((*x).base.vec[i0]);
        }
      }
    }
}
...
{
  struct alias_set_entry_d * const x = (struct alias_set_entry_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_17alias_set_entry_d, gt_ggc_e_17alias_set_entry_d))
    {
...
gt_pch_p_17alias_set_entry_d (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct alias_set_entry_d * const x ATTRIBUTE_UNUSED = (struct alias_set_entry_d *)x_p;
  if ((void *)(x) == this_obj)
