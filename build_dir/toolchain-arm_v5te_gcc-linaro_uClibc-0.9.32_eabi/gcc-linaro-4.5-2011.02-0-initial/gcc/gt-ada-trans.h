    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_11parm_attr_d ((*x).base.vec[i0]);
        }
      }
    }
}
    ...
    {
      {
        ...
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_11parm_attr_d ((*x).base.vec[i0]);
        }
      }
    }
}
...
{
  struct parm_attr_d * const x = (struct parm_attr_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_11parm_attr_d, gt_ggc_e_11parm_attr_d))
    {
...
gt_pch_p_11parm_attr_d (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct parm_attr_d * const x ATTRIBUTE_UNUSED = (struct parm_attr_d *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).first), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).last), cookie);
