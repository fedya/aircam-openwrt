...
void
gt_ggc_mx_VEC_c_goto_bindings_p_gc (void *x_p)
{
  struct VEC_c_goto_bindings_p_gc * const x = (struct VEC_c_goto_bindings_p_gc *)x_p;
    ...
    {
      {
        ...
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_15c_goto_bindings ((*x).base.vec[i0]);
        }
      }
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_11VEC_tree_gc ((*x).decls_in_scope);
      gt_ggc_m_24VEC_c_goto_bindings_p_gc ((*x).gotos);
    }
}
...
gt_pch_nx_c_inline_static (void *x_p)
{
  struct c_inline_static * x = (struct c_inline_static *)x_p;
  struct c_inline_static * xlimit = x;
  while (gt_pch_note_object (xlimit, xlimit, gt_pch_p_15c_inline_static, gt_ggc_e_15c_inline_static))
   xlimit = ((*xlimit).next);
  while (x != xlimit)
    {
...
void
gt_pch_nx_VEC_c_goto_bindings_p_gc (void *x_p)
{
  struct VEC_c_goto_bindings_p_gc * const x = (struct VEC_c_goto_bindings_p_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_24VEC_c_goto_bindings_p_gc, gt_ggc_e_24VEC_c_goto_bindings_p_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_15c_goto_bindings ((*x).base.vec[i0]);
        }
      }
    }
}
...
{
  struct c_goto_bindings * const x = (struct c_goto_bindings *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_15c_goto_bindings, gt_ggc_e_15c_goto_bindings))
    {
...
{
  struct c_label_vars * const x = (struct c_label_vars *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_12c_label_vars, gt_ggc_e_12c_label_vars))
    {
      ...
      gt_pch_n_11VEC_tree_gc ((*x).decls_in_scope);
      gt_pch_n_24VEC_c_goto_bindings_p_gc ((*x).gotos);
    }
}
...
{
  struct c_inline_static * const x ATTRIBUTE_UNUSED = (struct c_inline_static *)x_p;
  if ((void *)(x) == this_obj)
...
void
gt_pch_p_24VEC_c_goto_bindings_p_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_c_goto_bindings_p_gc * const x ATTRIBUTE_UNUSED = (struct VEC_c_goto_bindings_p_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_p_15c_goto_bindings (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct c_goto_bindings * const x ATTRIBUTE_UNUSED = (struct c_goto_bindings *)x_p;
  if ((void *)(x) == this_obj)
...
gt_pch_p_12c_label_vars (ATTRIBUTE_UNUSED void *this_obj,
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct c_label_vars * const x ATTRIBUTE_UNUSED = (struct c_label_vars *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).shadowed), cookie);
  if ((void *)(x) == this_obj)
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_r_gt_c_decl_h[] = {
  {
    &ext_block,
    1,
    sizeof (ext_block),
...
EXPORTED_CONST struct ggc_root_tab gt_ggc_rd_gt_c_decl_h[] = {
  { &binding_freelist, 1, sizeof (binding_freelist), NULL, NULL },
  { &scope_freelist, 1, sizeof (scope_freelist), NULL, NULL },
  LAST_GGC_ROOT_TAB
};

EXPORTED_CONST struct ggc_root_tab gt_pch_rs_gt_c_decl_h[] = {
