...
void
gt_ggc_mx_VEC_qualified_typedef_usage_t_gc (void *x_p)
{
  struct VEC_qualified_typedef_usage_t_gc * const x = (struct VEC_qualified_typedef_usage_t_gc *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_ggc_m_9tree_node ((*x).base.vec[i0].typedef_decl);
          gt_ggc_m_9tree_node ((*x).base.vec[i0].context);
        }
      }
    }
}
  ...
  while (x != xlimit)
    {
      switch (cp_tree_node_structure (&((*x))))
        ...
        case TS_CP_LAMBDA_EXPR:
          gt_ggc_m_9tree_node ((*x).lambda_expression.common.chain);
          gt_ggc_m_9tree_node ((*x).lambda_expression.common.type);
        ...
        case TS_CP_TEMPLATE_INFO:
          ...
          gt_ggc_m_9tree_node ((*x).template_info.common.type);
          gt_ggc_m_32VEC_qualified_typedef_usage_t_gc ((*x).template_info.typedefs_needing_access_checking);
          break;
        default:
          break;
        }
...
void
gt_pch_nx_VEC_qualified_typedef_usage_t_gc (void *x_p)
{
  struct VEC_qualified_typedef_usage_t_gc * const x = (struct VEC_qualified_typedef_usage_t_gc *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_32VEC_qualified_typedef_usage_t_gc, gt_ggc_e_32VEC_qualified_typedef_usage_t_gc))
    {
      {
        size_t i0;
        size_t l0 = (size_t)(((*x).base).num);
        for (i0 = 0; i0 != l0; i0++) {
          gt_pch_n_9tree_node ((*x).base.vec[i0].typedef_decl);
          gt_pch_n_9tree_node ((*x).base.vec[i0].context);
        }
      }
    }
}
  ...
  while (x != xlimit)
    {
      switch (cp_tree_node_structure (&((*x))))
        ...
        case TS_CP_TRAIT_EXPR:
          ...
          break;
        case TS_CP_LAMBDA_EXPR:
          gt_pch_n_9tree_node ((*x).lambda_expression.common.chain);
          gt_pch_n_9tree_node ((*x).lambda_expression.common.type);
        ...
        case TS_CP_TEMPLATE_INFO:
          ...
          gt_pch_n_9tree_node ((*x).template_info.common.type);
          gt_pch_n_32VEC_qualified_typedef_usage_t_gc ((*x).template_info.typedefs_needing_access_checking);
          break;
        default:
          break;
        }
...
void
gt_pch_p_32VEC_qualified_typedef_usage_t_gc (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct VEC_qualified_typedef_usage_t_gc * const x ATTRIBUTE_UNUSED = (struct VEC_qualified_typedef_usage_t_gc *)x_p;
  {
    size_t i0;
    size_t l0 = (size_t)(((*x).base).num);
    for (i0 = 0; i0 != l0; i0++) {
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].typedef_decl), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).base.vec[i0].context), cookie);
    }
  }
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch (cp_tree_node_structure (&((*x))))
    ...
    case TS_CP_LAMBDA_EXPR:
      if ((void *)(x) == this_obj)
        op (&((*x).lambda_expression.common.chain), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).lambda_expression.common.type), cookie);
      if ((void *)(x) == this_obj)
    ...
    case TS_CP_TEMPLATE_INFO:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).template_info.common.type), cookie);
      if ((void *)(x) == this_obj)
