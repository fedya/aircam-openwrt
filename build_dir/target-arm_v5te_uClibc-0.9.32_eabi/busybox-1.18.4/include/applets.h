...
IF_NANDWRITE(APPLET(nandwrite, _BB_DIR_USR_SBIN, _BB_SUID_DROP))
IF_NANDWRITE(APPLET_ODDNAME(nanddump, nandwrite, _BB_DIR_USR_SBIN, _BB_SUID_DROP, nanddump))
...
IF_GARP(APPLET(garp, _BB_DIR_SBIN, _BB_SUID_DROP))
...
IF_PWDOG(APPLET_NOFORK(pwdog, pwdog, _BB_DIR_BIN, _BB_SUID_DROP, pwdog))
